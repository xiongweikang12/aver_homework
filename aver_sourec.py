...
#TODO 增添框架：listbox各各学期的学习情况
frm_11=tk.Frame(frm_1)
frm_11.pack()
l_1=tk.Label(frm_11,text='listbox各各学期的学习情况',bg='yellow')
l_1.pack()
l_2=tk.Label(frm_11,textvariable='' ,bg='yellow',width=10,height=1)
l_2.pack()
...
def Get_item():
    pass
button_Choose_item=tk.Button(frm_11,text='获取可视化',width=10,height=1,bg='red',command=Get_item)
